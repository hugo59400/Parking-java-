...
public class Parc {
  ...
  public boolean enregistrerEntree(String immatriculation, int nbPersonnes, Parking parking) {
    return estAutorisee(immatriculation) && parking.enregistrerEntree(immatriculation,nbPersonnes);
